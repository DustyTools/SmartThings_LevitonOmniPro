/**
 *  Omni Pro Bridge - Strobe
 */
metadata {
	definition (name: "OmniPro Strobe", namespace: "taasss", author: "taasss") {
		capability "Alarm"
...
def siren() {
	log.trace "${device.displayName}.siren()"
	sendEvent(name: "alarm", value: "strobe")
}
...
def update(subType, status, originalJson) {
    ...
    sendEvent(name: "type", value: "Strobe", displayed: false)
